package com.docibly.dms.config;

import com.docibly.dms.common.util.KeyUtils;
...
public class BeansConfig {
    ...
    // Set on any host with an ephemeral/read-only filesystem (Railway, most PaaS free
    // tiers): without these, a restart or redeploy generates a brand-new RSA key pair
    // and silently invalidates every issued access/refresh token. Base64-encode the
    // full PEM file content, e.g. `base64 -w0 private_key.pem`.

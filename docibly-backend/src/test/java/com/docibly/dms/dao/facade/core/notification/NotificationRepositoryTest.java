...
@DisplayName("NotificationDao Integration Tests")
class NotificationRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("notification-test-ref-001");
        sample.setTitle("test-title");
        sample.setMessage("test-message");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            Notification saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("notification-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<Notification> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<Notification> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            Notification found = dao.findByRef("notification-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("notification-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            Notification found = dao.findByRef("non-existent-ref");

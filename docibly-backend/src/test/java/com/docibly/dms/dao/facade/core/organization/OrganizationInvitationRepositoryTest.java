...
@DisplayName("OrganizationInvitationDao Integration Tests")
class OrganizationInvitationRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("organizationinvitation-test-ref-001");
        sample.setInviteeEmail("test-inviteeemail");
        sample.setToken("test-token");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            OrganizationInvitation saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("organizationinvitation-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<OrganizationInvitation> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<OrganizationInvitation> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            OrganizationInvitation found = dao.findByRef("organizationinvitation-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("organizationinvitation-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            OrganizationInvitation found = dao.findByRef("non-existent-ref");

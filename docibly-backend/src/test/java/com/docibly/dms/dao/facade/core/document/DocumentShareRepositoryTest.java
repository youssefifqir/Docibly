...
@DisplayName("DocumentShareDao Integration Tests")
class DocumentShareRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("documentshare-test-ref-001");
        sample.setShareToken("test-sharetoken");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            DocumentShare saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("documentshare-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<DocumentShare> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<DocumentShare> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            DocumentShare found = dao.findByRef("documentshare-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("documentshare-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            DocumentShare found = dao.findByRef("non-existent-ref");

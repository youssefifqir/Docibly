...
class DocumentRepositoryTest {
    ...
    void setUp() {
        sample = new Document();
        sample.setRef("document-test-ref-001");
        ...
        sample.setStorageBucket("test-storagebucket");
    ...
    class Save {
        ...
        void persistsEntity() {
            Document saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("document-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<Document> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<Document> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            Document found = dao.findByRef("document-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("document-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            Document found = dao.findByRef("non-existent-ref");

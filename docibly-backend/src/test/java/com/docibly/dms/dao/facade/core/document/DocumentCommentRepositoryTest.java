...
@DisplayName("DocumentCommentDao Integration Tests")
class DocumentCommentRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("documentcomment-test-ref-001");
    ...
    class Save {
        ...
        void persistsEntity() {
            DocumentComment saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("documentcomment-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<DocumentComment> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<DocumentComment> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            DocumentComment found = dao.findByRef("documentcomment-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("documentcomment-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            DocumentComment found = dao.findByRef("non-existent-ref");

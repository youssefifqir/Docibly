...
@DisplayName("SearchIndexDao Integration Tests")
class SearchIndexRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("searchindex-test-ref-001");
        sample.setDocumentId(1L);
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            SearchIndex saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("searchindex-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<SearchIndex> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<SearchIndex> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            SearchIndex found = dao.findByRef("searchindex-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("searchindex-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            SearchIndex found = dao.findByRef("non-existent-ref");

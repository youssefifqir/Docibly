...
@DisplayName("OrganizationMemberDao Integration Tests")
class OrganizationMemberRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("organizationmember-test-ref-001");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            OrganizationMember saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("organizationmember-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<OrganizationMember> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<OrganizationMember> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            OrganizationMember found = dao.findByRef("organizationmember-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("organizationmember-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            OrganizationMember found = dao.findByRef("non-existent-ref");

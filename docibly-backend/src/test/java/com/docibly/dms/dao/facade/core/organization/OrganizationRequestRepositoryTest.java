...
@DisplayName("OrganizationRequestDao Integration Tests")
class OrganizationRequestRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("organizationrequest-test-ref-001");
        sample.setRequestedName("test-requestedname");
        sample.setRequestedSlug("test-requestedslug");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            OrganizationRequest saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("organizationrequest-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<OrganizationRequest> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<OrganizationRequest> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            OrganizationRequest found = dao.findByRef("organizationrequest-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("organizationrequest-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            OrganizationRequest found = dao.findByRef("non-existent-ref");

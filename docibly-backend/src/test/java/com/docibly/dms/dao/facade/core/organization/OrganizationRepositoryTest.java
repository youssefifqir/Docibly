...
@DisplayName("OrganizationDao Integration Tests")
class OrganizationRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("organization-test-ref-001");
    ...
    class Save {
        ...
        void persistsEntity() {
            Organization saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("organization-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<Organization> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<Organization> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            Organization found = dao.findByRef("organization-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("organization-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            Organization found = dao.findByRef("non-existent-ref");
